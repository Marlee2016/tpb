        ...
        <div class="hy_list">
            <div class="box_t">
                ...
                <div class="position">
                    ...
                    <a href="javascript:;"><?php echo ($cname); ?>新闻</a>
                    <span><img src="Assets/images/icon3.png" alt=""/></span>
                    <a href="javascript:;"><?php echo ($cname); ?>新闻列表</a>
                </div>
                <!--当前位置-->
            </div>
            <div class="space_hx">&nbsp;</div>
            <!--列表-->
            <table cellpadding="0" cellspacing="0" class="list_hy" style="width:90%" >
                <tr>
                ...
                <?php if(is_array($news)): $i = 0; $__LIST__ = $news;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$new): $mod = ($i % 2 );++$i;?><tr>
                        ...
                        <a href="/tpa/2022sessions.php/back/total/newsEdit/id/<?php echo ($new["id"]); ?>/cat/<?php echo ($cat); ?>" class="a-normal">编辑</a>&nbsp;&nbsp;
                        <a href="/tpa/2022sessions.php/back/total/newsDel/id/<?php echo ($new["id"]); ?>/cat/<?php echo ($cat); ?>" class="a-normal">删除</a>
                        </td>
