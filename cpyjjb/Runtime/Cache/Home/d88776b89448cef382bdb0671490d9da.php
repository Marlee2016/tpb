...
<head>
    ...
    <style>
        ...
        .banner {
            ...
            width: 100%;
            height: 20rem;
            background: url(img/index-s.jpg) no-repeat center center /100% 100%;
        }
        .tab-container {
            width: 100%;
            display: flex;
...
<div class="container">
    ...
    <div class="tab-content">
        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$new): $mod = ($i % 2 );++$i;?><a class="list_item" href="/tp/seme.php/Home/Index/news?id=<?php echo ($new["id"]); ?>&cid=<?php echo ($new["cid"]); ?>">
                <div class="cover">
