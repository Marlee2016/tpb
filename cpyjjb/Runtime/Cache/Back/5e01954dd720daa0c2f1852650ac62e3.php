    ...
    $(function () {
        $('.tj_btn a').click(function (e) {
            ...
            if (!title || !link) {
                ...
                $.post("/tp/sessions.php/back/total/newsEdit", {title:title,desc:desc, link:link,status:status, id:id}, function (res) {
                    if (res.code == 1) {
...
<script>
    $('#easyContainer').easyUpload({
        ...
        url: "/tp/sessions.php/back/total/newsEdit",//上传文件地址
