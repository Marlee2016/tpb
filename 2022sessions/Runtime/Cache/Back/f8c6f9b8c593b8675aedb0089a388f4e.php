...
<body style="background:url(images/bg.jpg) no-repeat;">
    <div class="container wrap1" style="height:450px;">
        <div class="col-sm-8 col-md-5 center-auto pd-sm-50 pd-xs-20 main_content">
            ...
            <form action="/tpa/2022sessions.php/back/User/login" method="post">
                ...
                <button type="submit" class="login_btn" href="javascript:void(0)">登  录</button>
           </form>
        </div>
    </div>
</body>
...
$(function () {
    $('button').click(function (e) {
        ...
        if (!user || !pass) {
            ...
            $.post("/tpa/2022sessions.php/back/User/login", {user:user, pass:pass}, function (res) {
                if (res.code == 1) {
