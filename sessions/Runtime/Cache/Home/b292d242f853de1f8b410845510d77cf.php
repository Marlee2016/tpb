...
<head>
    ...
    .wrapper02 {position:relative;height: 4rem;width: 100%;overflow: hidden;margin:0 auto;background:#ddd;margin-top: 8px;letter-spacing:2px;}
...
<!--         <div class="tab-container">
    北京昌平app
    <div class="cp-app active"><a href="/tp/sessions.php/home/index/lists?cat=app"></a></div>
    昌广传媒
    <div class="cgcm"><a href="/tp/sessions.php/home/index/lists?cat=cgcm"></a></div>
    昌平电视台
    <div class="cp-tv"><a href="/tp/sessions.php/home/index/lists?cat=tv"></a></div>
    昌平广播电台
    <div class="cp-radio"><a href="/tp/sessions.php/home/index/lists?cat=radio"></a></div>
    昌平报
    <div class="cp-papers"><a href="/tp/sessions.php/home/index/lists?cat=papers"></a></div>
</div> -->
    </div>
    <div class="wrapper wrapper02" id="wrapper02">
        <div class="scroller" id="trans">
            <ul class="clearfix">
                ...
                <li><a href="/tp/sessions.php/home/index/lists?cat=sm">使命</a></li>
                <li><a href="/tp/sessions.php/home/index/lists?cat=jj">聚焦</a></li>
                <li><a href="/tp/sessions.php/home/index/lists?cat=zb">直播</a></li>
                <li><a href="/tp/sessions.php/home/index/lists?cat=kz">快照</a></li>
                <li><a href="/tp/sessions.php/home/index/lists?cat=dbg">读报告</a></li>
                <li><a href="/tp/sessions.php/home/index/lists?cat=lz">履职</a></li>
                <li><a href="/tp/sessions.php/home/index/lists?cat=hg">回顾</a></li>
                <li><a href="/tp/sessions.php/home/index/lists?cat=zw">展望</a></li>
                <li><a href="/tp/sessions.php/home/index/lists?cat=ht">话题</a></li>
                <li><a href="/tp/sessions.php/home/index/lists?cat=hd">互动</a></li>
                <li><a href="/tp/sessions.php/home/index/lists?cat=jrp">今日评</a></li>
            </ul>
        </div>
     </div>
    <div class="tab-content">
<!--         <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$new): $mod = ($i % 2 );++$i;?><a class="list_item1" href="/tp/sessions.php/home/index/news?id=<?php echo ($new["id"]); ?>&cid=<?php echo ($cid); ?>&sta=<?php echo ($new["status"]); ?>">
<div class="cont">
...
<HR align='center'  width='96%' color='#C0C0C0' SIZE=1 class="bord">
        ...
        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$new): $mod = ($i % 2 );++$i;?><!-- <a  href="<?php echo ($new["link"]); ?>"> -->
            ...
            <a class="list_item" id ="/tp/sessions.php/home/index/news?id=<?php echo ($new["id"]); ?>&cid=<?php echo ($new["cid"]); ?>&sta=<?php echo ($new["status"]); ?>" href="<?php echo ($new["link"]); ?>">
                <div class="cont">
                    <h2 class="title"><?php echo ($new["title"]); ?></h2>
                    <p class="desc"><?php echo ($new["desc"]); ?></p>
                </div>
...
// console.log(menuitem.eq(3));
    ...
    if (cat =='sm') {menuitem.eq(1).css('background-color', 'red'); menuitem.eq(1).children().css('color','#fff');}
    if (cat =='jj') {menuitem.eq(2).css('background-color', 'red'); menuitem.eq(2).children().css('color','#fff');}
    if (cat =='zb') {menuitem.eq(3).css('background-color', 'red'); menuitem.eq(3).children().css('color','#fff');}
    if (cat =='kz') {menuitem.eq(4).css('background-color', 'red'); menuitem.eq(4).children().css('color','#fff');}
