    ...
    $(function () {
        $('.tj_btn a').click(function (e) {
            ...
            if (!title || !link) {
                ...
                $.post("/tpa/2022sessions.php/back/total/newsAdd", {title:title,desc:desc, link:link, status:status,cid:cid}, function (res) {
                    if (res.code == 1) {
...
<script>
    $('#easyContainer').easyUpload({
        ...
        url: "/tpa/2022sessions.php/back/total/newsAdd",//上传文件地址
