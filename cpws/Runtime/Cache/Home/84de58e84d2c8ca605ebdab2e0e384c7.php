...
<!--         <div class="tab-container">
    北京昌平app
    <div class="cp-app active"><a href="/tp/cpws.php/home/inde/lists?cat=app"></a></div>
    昌广传媒
    <div class="cgcm"><a href="/tp/cpws.php/home/inde/lists?cat=cgcm"></a></div>
    昌平电视台
    <div class="cp-tv"><a href="/tp/cpws.php/home/inde/lists?cat=tv"></a></div>
    昌平广播电台
    <div class="cp-radio"><a href="/tp/cpws.php/home/inde/lists?cat=radio"></a></div>
    昌平报
    <div class="cp-papers"><a href="/tp/cpws.php/home/inde/lists?cat=papers"></a></div>
</div> -->
    </div>
    ...
    <div class="wrapper wrapper02" id="wrapper02">
        <div class="scroller">
            <ul class="clearfix">
                ...
                <li><a href="/tp/cpws.php/home/inde/lists?cat=wybs">外语标识规范</a></li>
                <li><a href="/tp/cpws.php/home/inde/lists?cat=yyj">英语角</a></li>
                <!-- <li><a href="/tp/cpws.php/home/inde/lists?cat=wybs">外语标识规范</a></li> -->
                <!-- <li><a href="/tp/cpws.php/home/inde/lists?cat=yyj">英语角</a></li> -->
    ...
    <div class="tab-content">
        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$new): $mod = ($i % 2 );++$i;?><a class="list_item" id ="/tp/cpws.php/home/inde/news?id=<?php echo ($new["id"]); ?>&cid=<?php echo ($new["cid"]); ?>&sta=<?php echo ($new["status"]); ?>" href="<?php echo ($new["link"]); ?>">
            <!-- <a class="list_item" id ="/tp/cpws.php/home/inde/news?id=<?php echo ($new["id"]); ?>&cid=<?php echo ($new["cid"]); ?>&sta=<?php echo ($new["status"]); ?>" href="<?php echo ($new["link"]); ?>?id=<?php echo ($new["id"]); ?>&cid=<?php echo ($cid); ?>&sta=<?php echo ($new["status"]); ?>"> -->
            <!-- <a class="list_item" href="/tp/cpws.php/home/inde/news?id=<?php echo ($new["id"]); ?>&cid=<?php echo ($new["cid"]); ?>&sta=<?php echo ($new["status"]); ?>"> -->
                <div class="cont">
