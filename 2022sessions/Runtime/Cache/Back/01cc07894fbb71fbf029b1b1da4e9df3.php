            ...
            <div class="xjhy" style="padding:0px;">
                <ul class="hypz">
                    <li class="clearfix">
                        ...
                        <div class="li_r">
                            <input name="title" type="text" value="<?php echo ($new["title"]); ?>">
                            <i>*</i>
                        </div>
                    </li>
                    <li class="clearfix">
                        ...
                        <div class="li_r">
                            <input name="desc" type="text" value="<?php echo ($new["desc"]); ?>">
                            <i>*</i>
                        </div>
                    </li>
                    <li class="clearfix">
                        ...
                        <div class="li_r">
                            <input name="link" type="text" value="<?php echo ($new["link"]); ?>">
                            <i>*</i>
                        </div>
                    </li>
                    <li class="clearfix">
                        ...
                        <div class="li_r">
                            <input name="status" type="text" value="<?php echo ($new["status"]); ?>">
                            <i>*</i>
                        </div>
                    </li>
                    <li class="clearfix">
    ...
    $(function () {
        $('.tj_btn a').click(function (e) {
            ...
            if (!title || !link) {
                ...
                $.post("/tpa/2022sessions.php/back/total/newsEdit", {title:title,desc:desc, link:link,status:status, id:id}, function (res) {
                    if (res.code == 1) {
                        location.href = "<?php echo U('Total/lists');?>?cat="+$('input[name=cat]').val();
                    } else if (res.code == 2) {
                        alert('修改失败！');
                    } else if (res.code == 3) {
                        alert('请输入完整修改项信息！');
...
<script>
    $('#easyContainer').easyUpload({
        ...
        url: "/tpa/2022sessions.php/back/total/newsEdit",//上传文件地址
