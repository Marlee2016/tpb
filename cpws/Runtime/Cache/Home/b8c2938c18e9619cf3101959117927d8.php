...
<div class="container">
    ...
    <div class="wrapper wrapper02" id="wrapper02">
        <div class="scroller" id="trans">
            <ul class="clearfix">
                ...
                <li><a href="/tp/cpws.php/home/in/lists?cat=dwjw">对外交往</a></li>
                <li><a href="/tp/cpws.php/home/in/lists?cat=cpyx">昌平友协</a></li>
    ...
    <div class="tab-content">
        ...
        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$new): $mod = ($i % 2 );++$i;?><!-- <a  href="<?php echo ($new["link"]); ?>"> -->
            ...
            <a class="list_item" id ="/tp/cpws.php/home/in/news?id=<?php echo ($new["id"]); ?>&cid=<?php echo ($new["cid"]); ?>&sta=<?php echo ($new["status"]); ?>" href="<?php echo ($new["link"]); ?>">
                <div class="cont">
...
// console.log(menuitem.eq(3));
    ...
    if (cat =='dwjw') {menuitem.eq(1).css('background-color', '#1492FF'); menuitem.eq(1).children().css('color','#fff');}
    if (cat =='cpyx') {menuitem.eq(2).css('background-color', '#1492FF'); menuitem.eq(2).children().css('color','#fff');}
