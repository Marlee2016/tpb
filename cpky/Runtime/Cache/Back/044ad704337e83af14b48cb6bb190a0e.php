            ...
            <ol class="ydc-pane-list">
                <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "暂无相关数据" ;else: foreach($__LIST__ as $key=>$li): $mod = ($i % 2 );++$i;?><li>
                    <tr>
                       ...
                       <td width="8%"> <span><?php echo ($li["depict"]); ?></span></td>
                       <td width="5%"><span><a target="_blank" href="http://wx.bjcpn.com/cpky/upload/<?php echo ($li["newfile1"]); ?>">http://wx.bjcpn.com/cpky/upload/<?php echo ($li["newfile1"]); ?></a></span></td>
                       <td width="5%"><span><a target="_blank" href="http://wx.bjcpn.com/cpky/upload/<?php echo ($li["newfile2"]); ?>">http://wx.bjcpn.com/cpky/upload/<?php echo ($li["newfile2"]); ?></a></span></td>
                       <td width="5%"><span><a target="_blank" href="http://wx.bjcpn.com/cpky/upload/<?php echo ($li["newfile3"]); ?>">http://wx.bjcpn.com/cpky/upload/<?php echo ($li["newfile3"]); ?></a></span></td>
                       <td width="5%"><span><a target="_blank" href="http://wx.bjcpn.com/cpky/upload/<?php echo ($li["newfile4"]); ?>">http://wx.bjcpn.com/cpky/upload/<?php echo ($li["newfile4"]); ?></a></span></td>
                       <td width="5%"><span><a target="_blank" href="http://wx.bjcpn.com/cpky/upload/<?php echo ($li["newfile5"]); ?>">http://wx.bjcpn.com/cpky/upload/<?php echo ($li["newfile5"]); ?></a></span></td>
                       <td width="5%"><span><a target="_blank" href="http://wx.bjcpn.com/cpky/upload/<?php echo ($li["newfile6"]); ?>">http://wx.bjcpn.com/cpky/upload/<?php echo ($li["newfile6"]); ?></a></span></td>
