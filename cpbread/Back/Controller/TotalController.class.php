...
class TotalController extends BaseController
{
    ...
    public function newsAdd()
    {
        ...
        if (IS_POST) {
            ...
            if ($_FILES) {
                if ($_FILES['file']['error'] == 0) {
                    // 保存目录
                    $baseDir = $_SERVER ['DOCUMENT_ROOT'] . '/tp/Public/2018SecondMeeting/home/upload/';
            ...
            $cid   = I('post.cid');
            $pic   = session('pic');
            $rs    = $this->add($title, $desc,  $pic, $cid);
        ...
        // if ($cat == 'app') {
        //     $this->assign('defaultName', '北京昌平app两会新闻专题');
        //     $this->assign('defaultDesc', '北京昌平app两会新闻专题');
        // } else if ($cat == 'cgcm') {
        //     $this->assign('defaultName', '昌广传媒两会新闻专题');
        //     $this->assign('defaultDesc', '昌广传媒两会新闻专题');
        // }
    ...
    private function add($title, $desc,  $pic, $catId)
