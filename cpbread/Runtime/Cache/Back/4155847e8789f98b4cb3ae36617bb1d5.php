        ...
        <div class="hy_list">
        	<div class="box_t">
                ...
                <div class="position">
                    ...
                    <a href=""><?php echo ($cname); ?>新闻列表</a>
                    <span><img src="Assets/images/icon3.png" alt=""/></span>
                    <a href="">添加<?php echo ($cname); ?>新闻</a>
                </div>
                <!--当前位置-->
            </div>
    ...
    $(function () {
        $('.tj_btn a').click(function (e) {
            ...
            if (!title) {
                ...
                $.post("/tp/cpbread.php/back/total/newsAdd", {title:title,desc:desc,cid:cid}, function (res) {
                // $.post("/tp/cpbread.php/back/total/newsAdd", {title:title,desc:desc, link:link, status:status,cid:cid}, function (res) {
                    if (res.code == 1) {
...
<script>
    $('#easyContainer').easyUpload({
        ...
        url: "/tp/cpbread.php/back/total/newsAdd",//上传文件地址
